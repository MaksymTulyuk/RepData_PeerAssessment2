...
- get sorted summary of all fatalities
```{r, cache=TRUE}
...
- get sorted summary of all injuries
```{r, cache=TRUE}
...
- get summary of all fatalities and injuries
```{r, cache=TRUE}
...
Therefore, the most harmful event for humans is `r casualties[1,1]` with the total casualties `r casualties[1,4]` (fatalities `r casualties[1,2]` and injuries `r casualties[1,3]`)
